...
const QString BITCOIN_IPC_PREFIX("LinkChain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click LinkChain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start LinkChain: click-to-pay handler");
    else
...
{
    // clicking on LinkChain: URLs creates FileOpen events on the Mac:
