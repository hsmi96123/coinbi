...
// Copyright (c) 2017 The LinkChain developers
...
uint256 hashGenesisBlock("000004f06aff5ac71a3d337f1eba5e718f4e1c6e6bf67143fedebe84095cf081");
static const unsigned int timeGenesisBlock = 1536584511;
...
const string strMessageMagic = "LinkChain Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we LinkChain from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("a605a611ba3451df80780a9a3e3b2c2b46a938b9deacceaab6c93d34983bb91b"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LinkChainMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LinkChainMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("LinkChainMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("LinkChain-miner");
    ...
    try { loop {
        ...
        printf("Running LinkChainMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("LinkChainMiner terminated\n");
        throw;
    }
}
